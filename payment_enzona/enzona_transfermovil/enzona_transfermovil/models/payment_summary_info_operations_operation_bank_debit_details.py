...
class PaymentSummaryInfoOperationsOperationBankDebitDetails(BaseModel):
    """
    PaymentSummaryInfoOperationsOperationBankDebitDetails
    """ # noqa: E501
    trans_amount: Optional[StrictStr] = None
    currency: Optional[StrictStr] = None
    exchange_rate: Optional[StrictInt] = None
    discount: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["trans_amount", "currency", "exchange_rate", "discount"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "trans_amount": obj.get("trans_amount"),
