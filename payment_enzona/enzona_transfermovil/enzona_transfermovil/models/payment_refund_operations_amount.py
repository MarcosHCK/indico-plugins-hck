...
class PaymentRefundOperationsAmount(BaseModel):
    """
    PaymentRefundOperationsAmount
    """ # noqa: E501
    total: Optional[StrictInt] = None
    details: Optional[PaymentRefundOperationsAmountDetails] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "details": PaymentRefundOperationsAmountDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
