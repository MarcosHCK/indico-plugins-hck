...
class PaymentFullInfoPayer(BaseModel):
    """
    PaymentFullInfoPayer
    """ # noqa: E501
    payer_info: Optional[PaymentFullInfoPayerPayerInfo] = None
    __properties: ClassVar[List[str]] = ["payer_info"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "payer_info": PaymentFullInfoPayerPayerInfo.from_dict(obj.get("payer_info")) if obj.get("payer_info") is not None else None
        })
        return _obj
