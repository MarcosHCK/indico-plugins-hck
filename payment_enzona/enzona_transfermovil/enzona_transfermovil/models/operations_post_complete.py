...
class OperationsPostComplete(BaseModel):
    """
    ...
    items: Optional[List[OperationsPostCompleteItemsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [OperationsPostCompleteItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
