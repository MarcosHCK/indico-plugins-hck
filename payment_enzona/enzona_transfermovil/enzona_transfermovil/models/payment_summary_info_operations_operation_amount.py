...
class PaymentSummaryInfoOperationsOperationAmount(BaseModel):
    """
    PaymentSummaryInfoOperationsOperationAmount
    """ # noqa: E501
    total: Optional[StrictInt] = None
    currency: Optional[StrictStr] = None
    details: Optional[PaymentSummaryInfoOperationsOperationAmountDetails] = None
    __properties: ClassVar[List[str]] = ["total", "currency", "details"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "details": PaymentSummaryInfoOperationsOperationAmountDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
