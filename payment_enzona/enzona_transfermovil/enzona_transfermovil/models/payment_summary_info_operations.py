...
class PaymentSummaryInfoOperations(BaseModel):
    """
    PaymentSummaryInfoOperations
    """ # noqa: E501
    operation: Optional[PaymentSummaryInfoOperationsOperation] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "operation": PaymentSummaryInfoOperationsOperation.from_dict(obj.get("operation")) if obj.get("operation") is not None else None
        })
        return _obj
