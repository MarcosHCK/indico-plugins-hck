...
class FullOperations(BaseModel):
    """
    FullOperations
    """ # noqa: E501
    operation: Optional[FullOperationsOperation] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "operation": FullOperationsOperation.from_dict(obj.get("operation")) if obj.get("operation") is not None else None
        })
        return _obj
