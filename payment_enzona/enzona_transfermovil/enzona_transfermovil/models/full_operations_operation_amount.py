...
class FullOperationsOperationAmount(BaseModel):
    """
    FullOperationsOperationAmount
    """ # noqa: E501
    total: Optional[StrictInt] = None
    details: Optional[FullOperationsOperationAmountDetails] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "details": FullOperationsOperationAmountDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None
        })
        return _obj
