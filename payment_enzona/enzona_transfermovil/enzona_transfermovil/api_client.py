...
import enzona_transfermovil.models
from enzona_transfermovil import rest
from enzona_transfermovil.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(enzona_transfermovil.models, klass)
